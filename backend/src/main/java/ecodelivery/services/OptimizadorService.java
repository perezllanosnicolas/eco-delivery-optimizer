...
public class OptimizadorService {
   ...
   public OptimizadorService() {
   }

   public List<RecomendacionDTO> calcularOpciones(LocalDate var1, RutaFutura var2, List<RutaFutura> var3) {
         ...
         if (var8.paquetesActuales < var8.capacidadMaxima) {
            ...
            if (var9 >= 0 && var9 <= 7) {
               ...
               if (var16 > 0.0) {
                  ...
                  var4.add(new RecomendacionDTO(var8.puntoRecogidaAsociado, var8.fecha, var18, var8.paquetesActuales));
               }
            }
         }
      }
   ...
   public Map<String, Integer> obtenerMaximosPorUbicacion(List<RecomendacionDTO> var1) {
   ...
   public List<RecomendacionDTO> obtenerFechasParaUbicacion(List<RecomendacionDTO> var1, String var2) {
