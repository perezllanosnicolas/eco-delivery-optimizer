...
class GeneradorDatos {
   ...
   public static List<PuntoRecogida> generarPuntosDeRecogida(SimuladorConfig var0, String var1) {
   ...
   public static List<RutaFutura> generarRutas(SimuladorConfig var0, LocalDate var1, String var2, List<PuntoRecogida> var3) {
